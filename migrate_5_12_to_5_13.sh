...
docker volume create --label "com.docker.compose.project"="${currentdir}" --label "com.docker.compose.version"="2.23.0" --label "com.docker.compose.volume"="openc3-bucket-v" "${currentdir}_openc3-bucket-v"
