...
cp ../cosmos/scripts/linux/benchmark_s3_migration.sh scripts/linux/.
cp ../cosmos/scripts/linux/openc3_migrate_s3.sh scripts/linux/.
cp ../cosmos/scripts/linux/openc3_upgrade.sh scripts/linux/.
cp ../cosmos/scripts/linux/openc3_util.sh scripts/linux/.
cp ../cosmos/scripts/windows/openc3_migrate_s3.bat scripts/windows/.
